...
public class UsuarioService {
    ...
    public Optional<UsuarioDTO> buscarPorDocumento(String documento) {
        return this.usuarioRepository.findByDocumento(documento).map(this::convertDto);
    }

    public void excluir(String documento) {
        var usuario = this.usuarioRepository.findByDocumento(documento).orElseThrow();
        System.out.println(usuario);
        this.usuarioRepository.delete(usuario);
    }

    public UsuarioDTO atualizar(UsuarioDTO usuarioDto) {
        var usuario = this.usuarioRepository.findByDocumento(usuarioDto.getDocumento()).orElseThrow();
